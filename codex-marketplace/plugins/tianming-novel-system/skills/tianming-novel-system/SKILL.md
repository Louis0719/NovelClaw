...
description: |
  「天命」长篇小说协同创作系统。当用户说「写小说」「写书」「创作小说」「开始写作」
  「帮我写章节」「写第X章」「写大纲」「生成目录」「写正文」「开始正文」
  「检查知识库」「小说体检」「更新存档」，或需要保证跨章节的世界观一致性、
  伏笔回收、节奏控制、文风稳定时使用本 Skill。
  也支持精确指令格式：「天命：大纲」「天命：规划」「天命：目录」「天命：草案」
  「天命：正文」「天命：体检」「天命：存档」。
...
| 你的需求 | 对应指令 |
|---|---|
| 开始一本新书 | 直接告诉我你的想法，无需指令 |
| 生成大纲 | 「天命：大纲」 |
| 生成分卷规划 | 「天命：规划」 |
| 生成详细目录 | 「天命：目录 | 卷1 第1-20章」 |
| 写某一章正文 | 「天命：正文 | 卷1 第1章」 |
| 检查知识库健康 | 「天命：体检」 |
| 保存本次进展 | 「天命：存档」 |
| 不知道下一步做什么 | 告诉我你目前写到哪里了 |

---

## 六、首次创作时间线

按以下顺序推进，每步完成后天命会告知下一步：

```
1. 告诉我你的小说想法（题材/主角/核心卖点）
   ↓
2. 天命自动创建/检查知识库文件
   ↓
3. 确认《世界观规则》《角色档案》《文风样本》内容
   ↓
4. 「天命：大纲」→ 生成战略宏图
   ↓
5. 「天命：规划」→ 生成分卷蓝图
   ↓
6. 「天命：目录 | 卷1 第1-10章」→ 生成详细目录
   ↓
7. 「天命：正文 | 卷1 第1章」→ 开始写作
   ↓
   （重复步骤6-7直到本卷完成）
...
无需任何指令，直接告诉我你的小说想法，天命自动进入创作流程。

### 启动示例

> 「我想写一本都市言情，女主苏念28岁离婚后重新找到自己」
> 「我要写修仙文，主角林渊获得上古传承，一路逆袭」
> 「帮我写一个穿书文，女主穿越成恶毒女配只想摆烂」
> 「我想写末世爽文，主角觉醒废物系统，全球凶兽排队求收养」
